...
@given(parsers.cfparse('the basket has "{initial:Number}" cucumbers', extra_types=EXTRA_TYPES),converters=CONVERTERS, target_fixture='basket')
@given('the basket has "<initial>" cucumbers',converters=CONVERTERS, target_fixture='basket')
def basket(initial):
